...
public class ImagesLoader {
  ...
  private static final Image playIcon =
      new Image(ServerViewController.class.getResourceAsStream(IMAGE_PLAY));
  private static final Image folderIcon =
      new Image(ServerViewController.class.getResourceAsStream(IMAGE_FOLDER));
  private static final Image restartIcon =
      new Image(ServerViewController.class.getResourceAsStream(IMAGE_RESTART));
  private static final Image stopIcon =
      new Image(ServerViewController.class.getResourceAsStream(IMAGE_STOP));
  private static final Image settingsIcon =
      new Image(ServerViewController.class.getResourceAsStream(IMAGE_SETTINGS));
  private static final Image outputOn =
      new Image(ServerViewController.class.getResourceAsStream(IMAGE_BLINK_ON));
  private static final Image outputOff =
      new Image(ServerViewController.class.getResourceAsStream(IMAGE_BLINK_OFF));
