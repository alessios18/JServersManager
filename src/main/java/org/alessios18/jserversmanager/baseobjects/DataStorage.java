...
public class DataStorage {
  ...
  private DataStorage() throws UnsupportedOperatingSystemException, JAXBException {
    checkFiles();
  }

  public static DataStorage getInstance()
      throws UnsupportedOperatingSystemException, JAXBException {
    if (dataStorage == null) {
  ...
  public void checkFiles() throws UnsupportedOperatingSystemException, JAXBException {
  ...
  public BufferedWriter getServerLogBufferedWriter(Server server) throws IOException {
    File serverLog =
        new File(
            getLogPath()
                + server.getServerName().replace(" ", "_")
                + "-"
  ...
  public void saveConfig() throws JAXBException {
